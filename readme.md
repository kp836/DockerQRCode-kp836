...
the target website. You must make your program generate a QR code that takes someone to your GitHub homepage i.e. https://github.com/kp836
...
![alt text](images/GithubQRCode.JPEG)


2.  Add an image of viewing the log of successfully creating the QR code below.

 ![alt text](images/QRCodeLog.JPEG)
